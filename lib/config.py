...
SEMANTIC_DIPOLES_CORPORA = {
    'attributes':
        [
            ...
            ["a picture of a person with open lips.",
             "a picture of a person with closed lips."],
    ...
    'expressions':
        [
            ...
            ["a picture of a person with a sad face.",
             "a picture of a face in neutral expression."],
            ["a picture of a person with a fearful face.",
             "a picture of a face in neutral expression."],
            ["a picture of a face in disgust.",
             "a picture of a face in neutral expression."],
