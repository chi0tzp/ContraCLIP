...
# === GAN Type / Corpus ============================================================================================== #
gan="stylegan2_afhqdog512"     # Choose GAN type from lib/config.py:GENFORCE_MODELS
...
corpus="dogs"                  # Choose corpus of semantic dipoles from lib/config.py:SEMANTIC_DIPOLES_CORPORA
...
# === Training ======================================================================================================= #
batch_size=4                   # Set training batch size (cannot be larger than the size of the given corpus)
max_iter=20000                 # Set maximum number of training iterations
