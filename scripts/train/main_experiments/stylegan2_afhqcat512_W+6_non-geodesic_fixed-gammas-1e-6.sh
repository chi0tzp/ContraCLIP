...
# === GAN Type / Corpus ============================================================================================== #
gan="stylegan2_afhqcat512"     # Choose GAN type from lib/config.py:GENFORCE_MODELS
...
corpus="cats"                  # Choose corpus of semantic dipoles from lib/config.py:SEMANTIC_DIPOLES_CORPORA
