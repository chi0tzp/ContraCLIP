...
temperature=0.07               # Set temperature of contrasting loss
...
beta_css=0.5                   # Set the beta parameter for initialising the gamma parameters of the RBFs in the
...
# === Training ======================================================================================================= #
batch_size=1                   # Set training batch size (cannot be larger than the size of the given corpus)
